...
function AppRouter({ dispatch, view }) {
  ...
  const renderFab = (view) => {
    switch (view) {
      case Views.HOME:
        return <Fab component={Link} to="/all" color="primary" className={classes.fab}><Add /></Fab>
      case Views.ALL:
        return <Fab component={Link} to="/" color="primary" className={classes.fab}><Close /></Fab>
      case Views.STATS:
        return null
      default:
        return null
